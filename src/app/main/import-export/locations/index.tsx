...
const ImportExportLocations = () => {
    ...
    const { mutate, loading } = useMutation<ApiResponse<BulkUploadRes>>({
        endpoint: importExportApiRoute.importLocations,
        method: "post",
        ...
        <Row gutter={[0, 24]}>
            <Col span={24}>
                <div className="bg-[#F5F6FA] py-4 px-5 rounded-md">
                    <AppTitle level={4}>Import / Export Locations</AppTitle>
                </div>
            </Col>

            <Col span={24} className='import-card'>
                <ImportSection<LocationRow>
...
export default ImportExportLocations;